	...
	<table class="table table-bordered">
	    <strong>
		    <tr style="background-color: #CECECE">
		       ...
		       <th width="40%" class="text-center">Permasalahan</th>
		    </tr>
	    </strong>
	    ...
	    <tr>
	      ...
	      <td class="text-center"><?php echo date('j', strtotime(date($row->tanggal_bimbingan))).' '.$bulan[date('n',strtotime(date($row->tanggal_bimbingan)))].' '.date('Y', strtotime(date($row->tanggal_bimbingan)));?></td>
