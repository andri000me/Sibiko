...
<body onload="window.print()">
	<table width="100%">
		<th width="10%"><img src="<?php echo base_url('assets/dist/img/logo-smk2-128x128.jpg'); ?>" height="75" width="60"></th>
	...
	<table class="table table-bordered">
	    <strong>
		    <tr style="background-color: #CECECE">
		       ...
		       <th width="40%" class="text-center">Pelanggaran</th>
		       <th width="40%" class="text-center">Point</th>
		    </tr>
	    </strong>
	    <?php
	     $no=1;
	    ...
	    <tr>
	      ...
	      <td class="text-center"><?php echo $row->point_pelanggaran;?></td>
	    </tr>
	     <?php
	     	$no++;
	        	}
