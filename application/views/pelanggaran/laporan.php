...
<head>
    ...
    <title>Sistem DJITU SMK Negeri 2 Bojonegoro</title>
      ...
      <div class="modal-body form">
        <div>
             <!-- Nav tabs -->
                ...
                <form action="<?php base_url(); ?>laporan_siswa" method="POST" class="form-horizontal">
                      <div class="form-body">
                         <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input name="nama_siswa" placeholder="Keitk nama siswa" id="autocomplete" class="autocomplete form-control" style="width: 418px;" type="text">
                          </div>
                        </div>
                        <div class="form-group">
              ...
              <h3>Jumlah Point Pelanggaran</h3>
              <br>
              <div role="tabpanel" class="tab-pane" id="semuadata">
                    <form action="<?php base_url(); ?>laporan_point" method="POST" class="form-horizontal">
                      <div class="form-body">
                         <div class="form-group">
                          <label class="control-label col-md-3">Mulai Tanggal : </label>
                          <div class="col-md-9">
