...
<body onload="window.print()">
	...
	<hr>
		...
		<h4 class="text-center"><strong>LAPORAN PENGHARGAAN KEBAIKAN SISWA</strong></h4><br>
	<div class="row">
	    <div class="col-xs-12 col-sm-6 col-md-8">
	    	   <table class="table">
                ...
                <tr>
                	...
                	<td rowspan="4" width="150px"><right><img src="<?php echo base_url(); ?>assets/foto/<?php echo $row->nis; ?>.jpg" height="150" width="130" onerror="this.src='<?php echo base_url(); ?>assets/foto/default.jpg'"></right></td>
                </tr>
                <tr>
                ...
                <?php
			     ...
			     ?>
               	...
               	<table class="table">
                 <tr>
                	<h4><strong>Keterangan Penghargaan</strong></h4>
                </tr>
                <?php
                $no=1;
                $total=0;
			    ...
			    ?>
                <tr>
                <td class="text-center" rowspan="5"><?php echo $no;?>.</td>
                	<td width="160px">Tanggal</td>
                	<td width="5px">:</td>
                	<td><?php echo date('j', strtotime(date($row->tanggal_penghargaan))).' '.$bulan[date('n',strtotime(date($row->tanggal_penghargaan)))].' '.date('Y', strtotime(date($row->tanggal_penghargaan))); ?></td>
                ...
                <tr>
                	<td width="160px">Deskripsi Penghargaan</td>
                	<td width="5px">:</td>
                	<td><?php echo $row->deskripsi_penghargaan;?></td>
                </tr>
                <tr>
                	<td width="160px">Poin</td>
                	<td width="10px">:</td>
                	<td><?php echo $row->poin_penghargaan;?></td>
                </tr>
                <tr>
...
<div class="col-xs-4 col-sm-4">
               ...
               <table class="table table-bordered">
                <tr>
                    <td width="160px" height="10">Jumlah Penghargaan</td>
                    <td><?php echo " ". $no-1;?></td>
                </tr>
                <tr>
