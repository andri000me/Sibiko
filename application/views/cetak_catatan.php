        ...
        $(function(){
            $('.autocomplete').autocomplete({
                ...
                onSelect: function (suggestion) {
                    $('#nama_siswa').val(''+suggestion.nama_siswa); // membuat id 'v_nim' untuk ditampilkan
                ...
                <form action="<?php base_url(); ?>laporan_siswa" method="POST" class="form-horizontal">
                      <div class="form-body">
                         <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input name="nis" placeholder="Nomor Induk Siswa" id="autocomplete" class='autocomplete form-control 8' type="text" required="required">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-3">Nama</label>
                          <div class="col-md-9">
                            <input name="nama_siswa" id="nama_siswa" class="form-control" readonly></input>
                          </div>
                        </div>
                        <div class="form-group">
